    ...
    <div className="glass-panel" style={{
      ...
      <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '1.0px' }}>
          <span style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#3B82F6' }}>● Ingest</span>
          <span style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#0D9488' }}>● Vectorize</span>
          <span style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#F59E0B' }}>● Infer</span>
        </div>
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '900px', overflowX: 'auto' }}>
        ...
        >
          {/* Connecting Lines */}
          <path d="M 60 80 L 190 80" fill="none" stroke="rgba(59, 130, 246, 0.4)" strokeWidth="2" className="flow-line" />
          <path d="M 190 80 L 320 80" fill="none" stroke="rgba(107, 114, 128, 0.4)" strokeWidth="2" className="flow-line" />
          <path d="M 320 80 L 450 80" fill="none" stroke="rgba(124, 58, 237, 0.4)" strokeWidth="2" className="flow-line" />
          <path d="M 450 80 L 580 80" fill="none" stroke="rgba(13, 148, 136, 0.4)" strokeWidth="2" className="flow-line" />
          <path d="M 580 80 L 710 80" fill="none" stroke="rgba(124, 58, 237, 0.4)" strokeWidth="2" className="flow-line" />
          <path d="M 710 80 L 840 80" fill="none" stroke="rgba(16, 185, 129, 0.4)" strokeWidth="2" className="flow-line" />

          {/* Data Packets (Flying circles) */}
          <circle r="4.5" fill="#3B82F6" filter="drop-shadow(0 0 6px #3B82F6)">
            <animateMotion dur="6s" repeatCount="indefinite" path="M 60 80 L 190 80" keyPoints="0;1" keyTimes="0;0.166" calcMode="linear" />
          </circle>
          
          <circle r="4.5" fill="#6B7280" filter="drop-shadow(0 0 6px #6B7280)">
            <animateMotion dur="6s" repeatCount="indefinite" path="M 190 80 L 320 80" keyPoints="0;1" keyTimes="0.166;0.333" calcMode="linear" />
          </circle>

          <circle r="4.5" fill="#7C3AED" filter="drop-shadow(0 0 6px #7C3AED)">
            <animateMotion dur="6s" repeatCount="indefinite" path="M 320 80 L 450 80" keyPoints="0;1" keyTimes="0.333;0.5" calcMode="linear" />
          </circle>

          <circle r="4.5" fill="#0D9488" filter="drop-shadow(0 0 6px #0D9488)">
          ...
          <g className="node-doc" style={{ cursor: 'pointer' }}>
            <rect x="25" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#3B82F6" strokeWidth="1.5" />
          ...
          <g className="node-chunk" style={{ cursor: 'pointer' }}>
            <rect x="155" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#6B7280" strokeWidth="1.5" />
          ...
          <g className="node-embed" style={{ cursor: 'pointer' }}>
            <rect x="285" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#7C3AED" strokeWidth="1.5" />
          ...
          <g className="node-db" style={{ cursor: 'pointer' }}>
            <rect x="415" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#0D9488" strokeWidth="1.5" />
          ...
          <g className="node-retriever" style={{ cursor: 'pointer' }}>
            <rect x="545" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#7C3AED" strokeWidth="1.5" />
          ...
          <g className="node-llm" style={{ cursor: 'pointer' }}>
            <rect x="675" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#F59E0B" strokeWidth="1.5" />
          ...
          <g className="node-ans" style={{ cursor: 'pointer' }}>
            <rect x="805" y="55" width="70" height="50" rx="8" fill="rgba(10, 10, 15, 0.85)" stroke="#10B981" strokeWidth="1.5" />
